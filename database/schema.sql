...
CREATE TABLE Donor (
    ...
    weight REAL NOT NULL CHECK(weight >= 45.0),
    gender TEXT,
    blood_group TEXT NOT NULL CHECK(blood_group IN ('A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-')),
    last_donation_date DATE,
    availability_status TEXT DEFAULT 'Available' CHECK(availability_status IN ('Available', 'Temporarily Deferred', 'Permanently Deferred')),
    phone TEXT,
    email TEXT,
    address TEXT,
    city TEXT NOT NULL,
    latitude REAL,
    longitude REAL,
    is_registered BOOLEAN DEFAULT 1 CHECK(is_registered IN (0, 1)),
    last_health_screening DATE,
    hemoglobin REAL,
    blood_pressure TEXT,
    medical_clearance BOOLEAN DEFAULT 1 CHECK(medical_clearance IN (0, 1)),
